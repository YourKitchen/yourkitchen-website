...
const CookiesPage: React.FC = () => {
  return (
    <div className="policy">
      ...
      <p>
        Cookies set by the website owner (in this case, Unknown Studios) are
