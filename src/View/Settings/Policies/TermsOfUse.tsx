...
const TermsOfUsePage: React.FC = () => {
  return (
    <div>
      ...
      <p>
        The YourKitchen website located at https://yourkitchen.io is a
        copyrighted work belonging to YourKitchen. Certain features of the Site
      ...
      <p>
        ...
        YourKitchen uses ‘cookies’. These cookies are used to store information
      ...
      <p>
        ...
        Company should be sent to: Linus Paulings Vej 14, 3. th. After the
      ...
      <p>Address: Linus Paulings Vej 14, 3. th</p>
      <p>Email: makakwastaken@gmail.com</p>
    </div>
  )
}
