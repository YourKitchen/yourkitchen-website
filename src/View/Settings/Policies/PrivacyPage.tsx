...
const PrivacyPage: React.FC = () => {
  return (
    <div className="policy">
      ...
      <p>
        Thank you for choosing to be part of our community at Unknown Studios
      </p>
      <p>
      ...
      <p>
        ...
        us at{' '}
        <a href="mailto:abieshan@unknown-studios.com">
          abieshan@unknown-studios.com
        </a>
        .
      </p>
      <p>
      ...
      <p>In Short: information that you provide to us.</p>
      <p>
        ...
        depends on the context of your interactions with us and the Services or
        Apps, the choices you make and the products and features you use. The
        personal information we collect can include the following: Publicly
        Available Personal Information. We collect first name, maiden name, last
        name, and nickname; ID; email addresses; social media; and other similar
        data. Personal Information Provided by You. We collect app usage;
        passwords; and other similar data. Social Media Login Data. We may
      ...
      <p>
        ...
        automatically when you visit our Services or Apps. We automatically
        collect certain information when you visit, use or navigate the Services
        or Apps. This information does not reveal your specific identity (like
        ...
        our Services or Apps and other technical information. This information
        ...
        similar technologies. Online Identifiers. We collect devices; cookie
        identifiers, or others such as the ones used for analytics and
        marketing; and other similar data.
      </p>
      ...
      <p>
        ...
        responsibilities of Unknown Studios:
      </p>
      <p>
        ...
        manner in which any personal information are, or are to be used.
      </p>
      <p>
        “data processor”, in relation to personal information, means any person
      ...
      <p>
        ...
        controller and Unknown Studios is the data processor.
      </p>
      <p>
      ...
      <p>
        ...
        contact you about your use of our Services or Apps.
      </p>
      <p>
      ...
      <p>
        ...
        evaluate and improve our Services or Apps, products, marketing and your
      ...
      <p>
        ...
        revoke your consent, please contact us.Advertising, Direct Marketing,
        and Lead Generation
      </p>
      <p>
        AdMob, Facebook Audience Network and Google AdSense Allow Users to
        Connect to their Third-Party Accounts
      </p>
      <p>
        Facebook account, Google account and Apple account Cloud Computing
        Services
      </p>
      <p>Google Cloud Platform Communicate and Chat with Users</p>
      <p>Slack and Trello Content Optimization</p>
      <p>Google Fonts Functionality and Infrastructure Optimization</p>
      <p>
        Cloud Firestore, Cloud Functions for Firebase and Cloud Storage for
        Firebase Social Media Sharing and Advertising
      </p>
      <p>
        Firebase Dynamic Links and Facebook social plugins User Account
        Registration and Authentication
      </p>
      <p>
        Facebook Login, Firebase Authentication, Google Sign-In, Google OAuth
        2.0 and Apple Login Web and Mobile Analytics
      </p>
      <p>
        Google Analytics for Firebase, Google Analytics, Facebook Ads conversion
        tracking, Facebook Analytics and Google Ads Website Performance
        Monitoring
      </p>
      <p>Crashlytics and Firebase Crash Reporting Website Testing</p>
      <p>TestFlight and Beta by Crashlytics </p>
      ...
      <p>
        ...
        require us keeping your personal information for longer than 1 year past
      ...
      <br />
      <p>
        Account InformationIf you would at any time like to review or change the
      ...
      <p>
        ...
        will be notified about data breaches when Unknown Studios believes you
        are likely to be at risk or serious harm. For example, a data breach may
        be likely to result in serious financial harm or harm to your mental or
        physical well-being. In the event that Unknown Studios becomes aware of
        a security breach which has resulted or may result in unauthorized
        access, use or disclosure of personal information Unknown Studios will
      ...
      <p>
        ...
        Data Protection Officer (DPO), Abieshan Manoharan, by email at{' '}
        <a href="mailto:abieshan@unknown-studios.com">
          abieshan@unknown-studios.com
        </a>
        , by phone at +45 21224376, or by post to:
      </p>
      <p>
        <strong>Unknown Studios</strong>
      </p>
      <p>Silkeborgvej 7, 8000 Aarhus, Denmark</p>
      <p>Aarhus 8000, Denmark</p>
      <p>
        If you are a resident in the European Economic Area, the "data
        controller" of your personal information is Unknown Studios. Unknown
        Studios has appointed Abieshan Manoharan to be its representative in the
        EEA. You can contact them directly regarding the processing of your
        information by Unknown Studios, by email at{' '}
        <a href="abieshan@unknown-studios.com">abieshan@unknown-studios.com</a>,
        by visiting Silkeborgvej 7, 3. 1, by phone at +45 21224376, or by post
        to:
      </p>
      <p>Silkeborgvej 7, 3. 1</p>
      <p>Aarhus 8000, Denmark</p>

      <h4>
        HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOUR?
      </h4>
      <p>
