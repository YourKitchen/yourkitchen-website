  ...
  return (
    <div className="policy">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Markus
        Moltke.
      </p>{' '}
      <p>
        Markus Moltke is committed to ensuring that the app is as useful and
      ...
      <p>
        The YourKitchen app stores and processes personal data that you have
        ...
        features and it could mean that the YourKitchen app won’t work properly
        or at all.
      </p>{' '}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Markus Moltke
        ...
        can be Wi-Fi, or provided by your mobile network provider, but Markus
        Moltke cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Markus Moltke cannot always take responsibility
        ...
        avail the Service, Markus Moltke cannot accept responsibility.
      </p>{' '}
      <p>
        With respect to Markus Moltke’s responsibility for your use of the app,
        ...
        make it available to you. Markus Moltke accepts no liability for any
      ...
      <p>
        ...
        app. Markus Moltke does not promise that it will always update the app
        so that it is relevant to you and/or works with the iOS version that you
      ...
      <p>
        The YourKitchen app and website is not responsible for any allergic
        reactions according to consumption of any of the recipes, that may have
      ...
      <p>These terms and conditions are effective as of 2020-06-30</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at markus@unknown-studios.com.
      </p>{' '}
      <p>
